...
@allure.testcase('https://aj.srvdev.ru/browse/AIST-6663')
class TestGridKell(BaseTest):

	@allure.step('МД. Отображение поля Kell в гриде (регистратура донорского отделения)')
	@pytest.mark.parametrize('query, expected_color, expected_text_color, test_data_set_number', get_data('data_test_grid_kell.csv'))
