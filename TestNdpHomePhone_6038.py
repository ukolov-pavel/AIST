...
@allure.testcase('https://aj.srvdev.ru/browse/AIST-6038')
class TestNdpHomePhone(BaseTest):

	@allure.step('Валидация поля Домашний телефон (Контактная информация) при добавлении донора')
	@pytest.mark.parametrize('homephone, expected_result, test_data_set_number', get_data('data_test_ndp_homephone.csv'))
